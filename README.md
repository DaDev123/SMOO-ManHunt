...
1. Download the latest mod build from either [Gamebanana](https://gamebanana.com/mods/524513) or from the [Releases](https://github.com/DaDev123/SMOO-ManHunt/releases) tab. (Alternatively, build from source)
